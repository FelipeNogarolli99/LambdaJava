...
public class Main implements RequestHandler<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> handleRequest(Map<String, Object> input, Context context) {
        String pathParameters = (String) input.get("rasPath");
        ...
        try {
            ...
            throw new RuntimeException("error deserializzing URL data: " + e.getMessage(), e);
        }

        long currentTimeInSeconds = System.currentTimeMillis()/ 1000;
        if(currentTimeInSeconds < urlData.getExpirationTime()){
            Map<String, Object> responde = new HashMap<>();
            responde.put("statusCode", 302);
